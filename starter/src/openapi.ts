...
} from "./contratos/cartera.ts";
import { PagoRegistrado, RegistrarPagoRequest } from "./contratos/pagos.ts";
import { CreditoId, IdempotencyKey, ProblemDetails } from "./contratos/comunes.ts";
